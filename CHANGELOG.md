...
* **gen:** regenerate artifacts ([e85169d](https://github.com/camunda/orchestration-cluster-api-csharp/commit/e85169d8c3b07def4bdf2f881713546d2be5e255))
...
* **gen:** regenerate artifacts ([ee5b2a5](https://github.com/camunda/orchestration-cluster-api-csharp/commit/ee5b2a5aff633574fa3154843e025b56c3428a88))

## [9.1.1](https://github.com/camunda/orchestration-cluster-api-csharp/compare/v9.1.0...v9.1.1) (2026-05-13)


### Bug Fixes

* **gen:** regenerate artifacts ([16adfaa](https://github.com/camunda/orchestration-cluster-api-csharp/commit/16adfaa937be6735abea67f53c2d18e44f144ded))
* resolve $ref schemas for binary detection and add SendBinaryAsync tests ([98c29fc](https://github.com/camunda/orchestration-cluster-api-csharp/commit/98c29fc327c93cbf382baedf4a5c600e8ff1bbad))
* return byte[] for binary (octet-stream) response operations ([eeb1328](https://github.com/camunda/orchestration-cluster-api-csharp/commit/eeb1328d1cbe55cb993a02cd992ec51e2f463b4f))
...
* **generator:** sanitize spec-controlled strings against Unicode injection ([#116](https://github.com/camunda/orchestration-cluster-api-csharp/issues/116)) ([5492351](https://github.com/camunda/orchestration-cluster-api-csharp/commit/549235111371cbb635d68dd7b1185aaf1f5ca318)), closes [#117](https://github.com/camunda/orchestration-cluster-api-csharp/issues/117)
* **gen:** regenerate artifacts ([4f86fbe](https://github.com/camunda/orchestration-cluster-api-csharp/commit/4f86fbeb8444dc4f8e6b1e60a1c574dbe6db1b60))
...
* add docs badge for Nuget package page ([68dd191](https://github.com/camunda/orchestration-cluster-api-csharp/commit/68dd19137feb8763f41918076cf77d58e68c91c1))
...
* add technical preview note ([5bb497e](https://github.com/camunda/orchestration-cluster-api-csharp/commit/5bb497e3d94ca11f0e7ed21ad3796743513f2db9))
...
* **gen:** regenerate artifacts ([7d1f8fc](https://github.com/camunda/orchestration-cluster-api-csharp/commit/7d1f8fc32fa0c8a8984737b2c39a95413eb58c3c))
...
* materialize inline schemas as full types ([1fd9711](https://github.com/camunda/orchestration-cluster-api-csharp/commit/1fd97114c33e0188c9ff924729c23b5546414a46))
...
* rename package ([a9f4a4f](https://github.com/camunda/orchestration-cluster-api-csharp/commit/a9f4a4f845c5cc4a5813d95a5f87c204e1468cee))
...
* add idiomatic .NET config mechanisms ([ef9192c](https://github.com/camunda/orchestration-cluster-api-csharp/commit/ef9192c264c0d7f527d3a54cd35090cd8e7528b0))
