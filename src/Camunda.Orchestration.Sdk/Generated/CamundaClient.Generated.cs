...
public partial class CamundaClient
{
    ...
    /// 
    /// </summary>
    /// <remarks>Operation: createAgentInstance</remarks>
    ...
    /// 
    /// </summary>
    /// <remarks>Operation: getFormByKey</remarks>
    ...
    /// 
    /// </summary>
    /// <remarks>Operation: getResourceContentBinary</remarks>
    public async Task<object> GetResourceContentBinaryAsync(ResourceKey resourceKey, ConsistencyOptions<object>? consistency = null, CancellationToken ct = default)
    {
        ...
        if (consistency != null && consistency.WaitUpToMs > 0)
        {
            return await EventualPoller.PollAsync("getResourceContentBinary", true,
                () => InvokeWithRetryAsync(() => SendAsync<object>(HttpMethod.Get, path, null, ct), "getResourceContentBinary", false, ct),
                consistency!, _logger, ct);
        }

        return await InvokeWithRetryAsync(() => SendAsync<object>(HttpMethod.Get, path, null, ct), "getResourceContentBinary", false, ct);
    }
    ...
    /// 
    /// </summary>
    /// <remarks>Operation: updateAgentInstance</remarks>
